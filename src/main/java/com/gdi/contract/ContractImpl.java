...
public class ContractImpl extends Contract implements ContractInterface {
	...
	public Future<TransactionReceipt> addUser(String userAddress, String password, String userName) {
		Function function = new Function("addUser", Arrays.<Type>asList(new Address(userAddress),Util.stringToByte32(password),new Utf8String(userName)), Collections.<TypeReference<?>>emptyList());
		return executeTransactionAsync(function); 
	}

	@Override
	public Future<Bool> hasAlreadyRegister(String userName) {
		Function function = new Function("hasAlreadyRegister", Arrays.asList(new Utf8String(userName)),Arrays.<TypeReference<?>>asList(new TypeReference<Bool>() {}));
		return executeCallSingleValueReturnAsync(function);
	}

	@Override
	public CompletableFuture<List<Type>> getPasswordByUserName(String userName) {
		Function function = new Function("userPassByName", Arrays.asList(new Utf8String(userName)), 
	...
	public Future<TransactionReceipt> addIcoProject(String icoName, String jsonvalue, int preAmount, Long startTime, Long endTime) {
		Function function = new Function("addICOProject", Arrays.<Type>asList(Util.stringToByte32(icoName), new Utf8String(jsonvalue), new Uint256(preAmount), new Uint256(startTime), new Uint256(endTime)), Collections.<TypeReference<?>>emptyList());
		return executeTransactionAsync(function); 
	}
	...
	public Future<TransactionReceipt> attentionICOProject(String icoName, String userName) {
		Function function = new Function("attentionICOProject", Arrays.<Type>asList(Util.stringToByte32(icoName),new Utf8String(userName)), Collections.<TypeReference<?>>emptyList());
		return executeTransactionAsync(function); 
	}

	@Override
	public Future<TransactionReceipt> removeAttentionICOProject(String icoName, String userName) {
		Function function = new Function("removeAttentionICOProject", Arrays.<Type>asList(Util.stringToByte32(icoName),new Utf8String(userName)), Collections.<TypeReference<?>>emptyList());
		return executeTransactionAsync(function); 
	}

	@Override
	public Future<Bool> hasAttention(String icoName, String userName) {
		Function function = new Function("hasAttention", Arrays.asList(Util.stringToByte32(icoName), new Utf8String(userName)),Arrays.<TypeReference<?>>asList(new TypeReference<Bool>() {}));
		return executeCallSingleValueReturnAsync(function);
	}

	@Override
	public Future<Uint256> myAttentionNumber(String userName) {
		Function function = new Function("myAttentionNumber", Arrays.asList(new Utf8String(userName)),
				Arrays.<TypeReference<?>>asList(new TypeReference<Uint256>() {
				}));
		return executeCallSingleValueReturnAsync(function);
	}
	...
	public Future<Uint256> allAttentionNumber(String userName) {
		Function function = new Function("allAttentionNumber", Arrays.asList(new Utf8String(userName)),
				Arrays.<TypeReference<?>>asList(new TypeReference<Uint256>() {
				}));
		return executeCallSingleValueReturnAsync(function);
	}
	...
	public CompletableFuture<List<Type>> myAttentionIcoInfo(String userName, int i) {
		Function function = new Function("myAttentionIcoInfo", Arrays.asList(new Utf8String(userName),new Uint256(BigInteger.valueOf(i))),
				Arrays.<TypeReference<?>>asList(new TypeReference<Bool>() {
				}, new TypeReference<Utf8String>() {
				}, new TypeReference<Uint256>() {
				}, new TypeReference<Uint256>() {
	...
	public Future<TransactionReceipt> storeUserInvest(Order order) {
		Function function = new Function("storeUserInvest", Arrays.<Type>asList(new Address(order.getUserAddress()),Util.stringToByte32(order.getTokenName()), new Utf8String(order.getTradeAddr()), new Uint256(BigInteger.valueOf(order.getAmount())),new Utf8String(order.getDate())), Collections.<TypeReference<?>>emptyList());
		return executeTransactionAsync(function); 
	}
